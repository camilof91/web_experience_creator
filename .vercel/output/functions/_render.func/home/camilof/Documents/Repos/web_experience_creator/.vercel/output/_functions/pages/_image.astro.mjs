import { A as AstroError, f as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, g as ExpectedImageOptions, h as ExpectedImage, i as ExpectedNotESMImage, r as resolveSrc, j as isRemoteImage, k as isESMImportedImage, l as isLocalService, D as DEFAULT_HASH_PROPS, m as InvalidImageService, n as ImageMissingAlt, o as AstroError$1, p as InvalidImageService$1, q as isRemotePath, s as isRemoteAllowed } from '../chunks/astro/assets-service_CDudI_dv.mjs';
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, s as spreadAttributes, b as createAstro } from '../chunks/astro/server__MdIT-B0.mjs';
import 'clsx';
...
async function getConfiguredImageService$1() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_CDudI_dv.mjs'
    ).then(n => n.$).catch((e) => {
...
}, "/home/camilof/Documents/Repos/web_experience_creator/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/camilof/Documents/Repos/web_experience_creator/node_modules/astro/components/Picture.astro", void 0);
